# getReleaseSearchContract sequence (generated)
...
sequenceDiagram
    ...
    Client->>Router: GET /api/contracts/releases/{release_id}/search
    Router->>Router: Resolve typed contract directory dependency
    Router->>Functions: read_search_contract(...) 
    Functions->>Loader: contract_loader.read_search_index(...) 
    ...
    Functions-->>Router: typed SearchContractResponse response
