# getReleaseVideoContract sequence (generated)
...
sequenceDiagram
    ...
    Client->>Router: GET /api/contracts/releases/{release_id}/videos/{video_id}
    Router->>Router: Resolve typed contract directory dependency
    Router->>Functions: read_video_contract(...) 
    Functions->>Loader: contract_loader.read_video(...) 
    ...
    Functions-->>Router: typed VideoContractResponse response
