...
description: 要件定義に関する計画、作成、変更、レビュー、完了判定を、repository同梱のSWEBOK/Well-Architectedチェックリストで証跡ベースに自己検査する。発見・要件定義の作業、関連成果物の更新、工程gateの判定時に使用する。
---
...
2. 要求の獲得、分析、仕様化、妥当性確認、変更管理を、正本、contract、test、docsと同じ変更単位で実装する。
