...
description: 保守に関する計画、作成、変更、レビュー、完了判定を、repository同梱のSWEBOK/Well-Architectedチェックリストで証跡ベースに自己検査する。保守・変更の作業、関連成果物の更新、工程gateの判定時に使用する。
---
...
2. 保守計画、影響分析、変更、回帰、移行、廃止を、正本、contract、test、docsと同じ変更単位で実装する。
