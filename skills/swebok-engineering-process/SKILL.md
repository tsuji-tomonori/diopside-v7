---
name: swebok-engineering-process
description: プロセスに関する計画、作成、変更、レビュー、完了判定を、repository同梱のSWEBOK/Well-Architectedチェックリストで証跡ベースに自己検査する。全工程の作業、関連成果物の更新、工程gateの判定時に使用する。
---
...
2. ライフサイクル、プロセス定義、評価、測定、継続的改善を、正本、contract、test、docsと同じ変更単位で実装する。
