---
name: swebok-google-cloud
description: Google Cloudに関する計画、作成、変更、レビュー、完了判定を、repository同梱のSWEBOK/Well-Architectedチェックリストで証跡ベースに自己検査する。Google Cloud設計・運用の作業、関連成果物の更新、工程gateの判定時に使用する。
---

# Google CloudのAI駆動セルフチェック
...
2. Google Cloud Architecture Framework各柱とサービス固有の統制を、正本、contract、test、docsと同じ変更単位で実装する。
